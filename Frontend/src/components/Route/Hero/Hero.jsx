...
const Hero = () => {
  return (
    <div className={`relative min-h-[70vh] md:min-h-[80vh] bg-cover
     bg-center bg-no-repeat ${styles.noramlFlex} w-full`}
      style={{
    ...
    >
      <div className={`${styles.section} w-[90%] md:w-[60%] `}>
        ...
        <p className='pt-3 text-[16px] font-[Poppins] font-[400] text-[#000000ba]'>
