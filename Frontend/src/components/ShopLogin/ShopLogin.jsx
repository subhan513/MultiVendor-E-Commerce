...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    axios.post(`${server}/shop/shop-login`,{email,password},{withCredentials : true}).then((res)=>{
  ...
  return (
    <div className='bg-gray-50 min-h-screen flex flex-col justify-center py-12 md:px-6 lg:px-8'>
      <div className='sm:mx-auto sm:w-full sm:max-w-md'>
        <h2 className='mt-6 text-center text-3xl font-bold text-gray-800'>Login to your Shop</h2>
